...
type EntityResponseType = HttpResponse<IEventDetails>;
type EntityArrayResponseType = HttpResponse<IEventDetails[]>;

@Injectable({ providedIn: 'root' })
export class EventDetailsService {
  public resourceUrl = SERVER_API_URL + 'api/event-details';
  ...
  update(eventDetails: IEventDetails): Observable<EntityResponseType> {
    return this.http.put<IEventDetails>(this.resourceUrl, eventDetails, { observe: 'response' });
  }
